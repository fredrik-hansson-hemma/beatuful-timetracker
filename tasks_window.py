...
class TasksWindow(Gtk.Window):
    ...
    def _build_ui(self):
        ...
        # TreeView for tasks
        # Columns: id, name, total_time, active, description
        self.tasks_store = Gtk.ListStore(int, str, str, bool, str)
    ...
    def _on_edit_task(self, button):
        ...
        if tree_iter:
            ...
            current_desc = model[tree_iter][4]
            ...
            if response == Gtk.ResponseType.OK and name:
                try:
                    self.db.update_task(task_id, name, description)
                    self._refresh_tasks()
